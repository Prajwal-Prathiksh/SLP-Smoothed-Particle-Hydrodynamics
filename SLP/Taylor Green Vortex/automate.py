...
edac_cmds = [
    ...
    'pysph run taylor_green --perturb 0.2 --openmp --scheme edac --nx 100 -d 00-2',
    'pysph run taylor_green --perturb 0.2 --openmp --scheme edac --nx 150 -d 00-3',
]
...
tvf_cmds = [
    ...
    'pysph run taylor_green --perturb 0.2 --openmp --scheme tvf --nx 100 -d 01-2',
    'pysph run taylor_green --perturb 0.2 --openmp --scheme tvf --nx 150 -d 01-3',
]

dpsph_cmds = [
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --nx 30 -d 02-0',
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --nx 50 -d 02-1',
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --nx 100 -d 02-2',
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --nx 150 -d 02-3',
]
...
dpsph_LV_cmds = [
    ...
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --visc-correct --nx 100 -d 03-2',
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --visc-correct --nx 150 -d 03-3',
]
...
dpsph_TVF_cmds = [
    ...
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --tvf-correct --nx 100 -d 04-2',
    'python Taylor_Green-PySPH.py --perturb 0.2 --openmp --tvf-correct --nx 150 -d 04-3',
]
